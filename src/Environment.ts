...
type Opts = {
  notificationContext?: NotificationContextType | null | undefined;
  registerMarkdown?: (markdown: string) => void;
};

function createFetchQuery(opts: Opts | null | undefined) {
...
function createHandlerProvider(opts?: Opts | null | undefined) {
...
export function createEnvironment(opts?: Opts | null | undefined) {
