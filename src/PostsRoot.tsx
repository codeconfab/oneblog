...
import type { PostsRoot_Query, PostsRoot_QueryResponse } from "./__generated__/PostsRoot_Query.graphql";
...
export const PostsRoot = () => {
  const data: PostsRoot_QueryResponse | null | undefined = useLazyLoadQuery<PostsRoot_Query>(query, // $FlowFixMe: expects variables that were persisted
  {}, {
